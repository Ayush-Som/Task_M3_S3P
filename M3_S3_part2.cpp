...
#define MAX 8 // define the size of the matrices
...
const int max = MAX;
const int TS = 4; // define the tile size for the matrix multiplication
const size_t local[2] = {TS, TS}; // define the local work group size for the kernel
const size_t global[2] = {max, max}; // define the global work size for the kernel

void init(int a[MAX][MAX]); // function to initialize a matrix with random values
void matrix_mul(int a[MAX][MAX], int b[MAX][MAX], int c[MAX][MAX]); // function to multiply two matrices
void print_matrix(int a[MAX][MAX]); // function to print the values in a matrix
